...
bool Compare(const Customer &i, const Customer &j) 
 ...
 vector<goodTeller> *goodTellerVector = new vector<goodTeller>(5);
 //typedef vector< vector<goodTeller> > matrix;
 //matrix name(sizeX, std::vector<double>(sizeY));
 vector<badTeller> *badTellerVector = new vector<badTeller>(10);
 vector<manager> *managerVector = new vector<manager>(1);
